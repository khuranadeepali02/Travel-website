...
const PlacesCard = ({img,title,description,type,price,location,handleOrderPopup}) => {
  return (
    <div className='shadow-lg transition-all duration-500 hover:shadow-xl cursor-pointer bg-white'
